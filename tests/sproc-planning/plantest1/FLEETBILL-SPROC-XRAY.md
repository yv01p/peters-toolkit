...
```
prc_apply_rate_rules|4|0|11|none|04-prc_apply_rate_rules.sql
prc_settlement_sweep|2|2|1|none|05-prc_settlement_sweep.sql
prc_purge_stale_holds|0|0|0|none|06-prc_purge_stale_holds.sql
fn_trip_surcharge|2|0|2|none|07-fn_trip_surcharge.sql
pkg_fleet_billing.load_driver_batch|3|0|0|%ROWTYPE, VARRAY, REF CURSOR|02-pkg_fleet_billing.pks:7-11 / 03-pkg_fleet_billing.pkb:9-13
pkg_fleet_billing.post_batch_totals|1|1|0|none|02-pkg_fleet_billing.pks:14-16 / 03-pkg_fleet_billing.pkb:37-39
```
...
| `prc_purge_stale_holds` | 0 | 0 | 0 | none | 06-prc_purge_stale_holds.sql |
| `fn_trip_surcharge` | 2 | 0 | 2 | none | 07-fn_trip_surcharge.sql |
| `pkg_fleet_billing.load_driver_batch` | 3 | 0 | 0 | `%ROWTYPE`, VARRAY (`t_charge_code_list`), `REF CURSOR` (`t_charge_cur`) | 02-pkg_fleet_billing.pks:7-11 / 03-pkg_fleet_billing.pkb:9-13 |
| `pkg_fleet_billing.post_batch_totals` | 1 | 1 | 0 | none | 02-pkg_fleet_billing.pks:14-16 / 03-pkg_fleet_billing.pkb:37-39 |
| **Totals** | **12** | **3** | **14** | — | — |
